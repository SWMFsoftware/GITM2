    ...
    do iLon = 1, nLons
      do iLat = 1, nLats
        do iAlt = 1, nAlts
          ...
          Xyz_gitm(1,iLon,iLat,iAlt,iBlock) = (Altitude_GB(iLon,iLat,iAlt,iBlock) + rBody)/1.e3*temp1!sin(Longitude(iLon,iBlock))*cos(Latitude(iLat,iBlock))
          Xyz_gitm(2,iLon,iLat,iAlt,iBlock) = (Altitude_GB(iLon,iLat,iAlt,iBlock) + rBody)/1.e3*temp2!sin(Longitude(iLon,iBlock))*sin(Latitude(iLat,iBlock))
          Xyz_gitm(3,iLon,iLat,iAlt,iBlock) = (Altitude_GB(iLon,iLat,iAlt,iBlock) + rBody)/1.e3*cos(Longitude(iLon,iBlock))
